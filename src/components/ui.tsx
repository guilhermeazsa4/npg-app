...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="whatsapp-animate whatsapp-shake group relative fixed bottom-5 right-5 z-50 inline-flex min-h-14 items-center justify-center gap-3 overflow-hidden rounded-[8px] border border-[#34D058]/50 bg-[#1FAF67] px-5 text-sm font-black text-white shadow-[0_16px_42px_rgba(31,175,103,0.35),inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1px_0_rgba(0,80,40,0.15)] backdrop-blur-xl hover:-translate-y-1 hover:bg-[#22C55E] hover:shadow-[0_20px_54px_rgba(31,175,103,0.45),inset_0_1px_0_rgba(255,255,255,0.4)] active:scale-95"
    >
