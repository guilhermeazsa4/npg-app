...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="whatsapp-animate fixed bottom-5 right-5 z-50 inline-flex min-h-14 items-center justify-center gap-3 rounded-[4px] bg-[#1FAF67] px-5 text-sm font-black text-white shadow-[0_18px_42px_rgba(31,175,103,0.34)] transition-transform hover:-translate-y-1 hover:bg-[#168E53] active:scale-95"
    >
      <svg aria-hidden="true" className="h-6 w-6" fill="#ffffff" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
